    ...
    launch: function () {
        ...
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                //Ext.create('YZSoft.connection.connections.WebService.Dlg', {
                //    autoShow: true,
                //    folder: 'QML',
                //    objectName: 'WebService EAS',
                //    fn: function (ds) {
                //    }
                //});

                //Ext.create('YZSoft.src.dialogs.CallWebService', {
                //    autoShow: true,
                //    requestSchema1: {
                //        Payload: {
                //            type: 'object',
                ...
                //var pnl = Ext.create('YZSoft.esb.designer.FlowDesigner', {
                //    region: 'center',
                //    designMode: 'edit', 
                //    folder: 'QML',
                //    flowName: 'K3WISETEST'
                ...
                //var pnl =  Ext.create('YZSoft.report.Panel', {
                //    region: 'center',
                //    path: 'QML测试'
                //});
