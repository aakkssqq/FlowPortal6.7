...
Ext.define('YZSoft.bpm.src.flowchart.dialogs.FreeRouting', {
    ...
    constructor: function (config) {
        ...
        me.pnlGeneral = Ext.create('YZSoft.bpm.propertypages.FreeRoutingGeneral', {
            padding: '26 26 0 26',
            relatedFile: config.property.sprite.drawContainer.process.Property.RelatedFile
        });

        me.pnlParticipant = Ext.create('YZSoft.bpm.propertypages.FreeRoutingParticipant', {
            padding: '26 26 0 26',
    ...
    fill: function (data) {
        ...
        me.pnlParticipant.fill(data.ParticipantDeclare);
    ...
    save: function () {
        ...
        data.ParticipantDeclare = me.pnlParticipant.save();
