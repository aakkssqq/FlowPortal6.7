...
Ext.define('YZSoft.bpm.template.Panel', {
    ...
    deleteTemplates: function () {
        ...
        Ext.Msg.show({
            ...
            msg: RS.$('TaskOpt_DeleteFormTemplates_Confirm'),
            ...
            fn: function (btn, text) {
                ...
                YZSoft.Ajax.request({
                    ...
                    params: {
                        method: 'DeleteFormTemplates'
                    },
                    jsonData: {
                        items: items
                    },
                    waitMsg: {
                        msg: RS.$('TaskOpt_DeleteFormTemplates_LoadMask'),
                        target: me.grid
                    },
                    success: function (action) {
                        me.grid.getStore().reload({
                            loadMask: {
                                msg: Ext.String.format(RS.$('TaskOpt_DeleteFormTemplates_Success'), recs.length)
                            }
                        });
                    },
