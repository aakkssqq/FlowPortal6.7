Ext.define('YZSoft.bpm.report.ProcessUsage', {
    ...
    initComponent: function () {
        ...
        me.chartMain = Ext.create('YZSoft.bpm.src.chart.ProcessUsage', {
            ui: 'yzdashboard'
        });
        ...
        me.chartProportion = Ext.create('YZSoft.bpm.src.chart.ProcessUsageProportion', {
            ui: 'yzdashboard'
        });
        ...
        me.chartTop20 = Ext.create('YZSoft.bpm.src.chart.ProcessUsageTop20', {
            ui: 'yzdashboard'
        });
        ...
        me.items = [me.pnlKpi, {
            ...
            items: [{
                xtype: 'panel',
                title: RS.$('Analysis_PorcessUsageProportion'),
    ...
    getReportTitle: function (periodRawValue) {
        ...
        if (periodRawValue.Type == 'year')
            return Ext.String.format(RS.$('Analysis_ProcessUsageYearTendencyChart'), periodRawValue.Year);
        else
            return Ext.String.format(RS.$('Analysis_ProcessUsageMonthTendencyChart'), periodRawValue.Year, Ext.Date.getShortMonthName(periodRawValue.Month));
    }
});
