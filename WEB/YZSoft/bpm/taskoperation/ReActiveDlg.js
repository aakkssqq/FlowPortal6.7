...
stepid:
*/
Ext.define('YZSoft.bpm.taskoperation.ReActiveDlg', {
    extend: 'Ext.window.Window', //444444
    requires: [
        'YZSoft.bpm.src.ux.Render'
    ],
    title: RS.$('All_TaskReActive'),
    ...
    constructor: function (config) {
        ...
        me.edtSteps = Ext.create('YZSoft.src.form.field.List', {
            ...
            listeners: {
                browserClick: function (values) {
                    var editor = this;
                    if (!me.dlg) {
                        me.dlg = Ext.create('YZSoft.bpm.taskoperation.SelReActiveStepDlg', {
        ...
        me.edtComments = Ext.create('Ext.form.field.TextArea', Ext.apply({
            fieldLabel: RS.$('All_ReActiveComments'),
            grow: true,
            listeners: {
                change: function () {
                    me.updateStatus();
