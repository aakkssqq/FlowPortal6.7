/*
*/
Ext.define('YZSoft.bpm.taskoperation.InviteIndicateDlg', {
    extend: 'Ext.window.Window', //444444
    requires: [
        'YZSoft.bpm.src.ux.Render'
    ],
    title: RS.$('All_InviteIndicate'),
    ...
    constructor: function (config) {
        ...
        me.edtUsers = Ext.create('YZSoft.src.form.field.Users', {
            fieldLabel: RS.$('All_InviteIndicateUsers'),
            listeners: {
                change: function () {
                    me.updateStatus();
                }
        ...
        me.edtComments = Ext.create('Ext.form.field.TextArea', Ext.apply({
            fieldLabel: RS.$('All_InviteIndicateComments'),
            grow: true,
            listeners: {
                change: function () {
                    me.updateStatus();
        ...
        me.informPanel = Ext.create('Ext.Component', {
            ...
            data: {
                info: RS.$('All_InviteIndicateCfm_Msg')
            }
        });
