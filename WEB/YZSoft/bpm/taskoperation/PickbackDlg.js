...
stepid:
*/
Ext.define('YZSoft.bpm.taskoperation.PickbackDlg', {
    ...
    constructor: function (config) {
        ...
        me.edtSteps = Ext.create('YZSoft.src.form.field.List', {
            ...
            listeners: {
                browserClick: function (values) {
                    var editor = this;
                    if (!me.dlg) {
                        me.dlg = Ext.create('YZSoft.bpm.taskoperation.SelPickbackStepDlg', {
                            title: RS.$('All_Pickback'),
        ...
        me.edtComments = Ext.create('Ext.form.field.TextArea', Ext.apply({
            fieldLabel: RS.$('All_PickbackComments'),
            grow: true,
            listeners: {
                change: function () {
                    me.updateStatus();
        ...
        me.btnOK = Ext.create('Ext.button.Button', {
            ...
            cls: 'yz-btn-default',
            handler: function () {
                me.closeDialog(me.edtSteps.getValue()[0], me.edtComments.getValue());
            }
        });
