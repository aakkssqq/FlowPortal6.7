/*
*/
Ext.define('YZSoft.bpm.taskoperation.HandoverDlg', {
    extend: 'Ext.window.Window', //444444
    requires: [
        'YZSoft.bpm.src.ux.Render'
    ],
    title: RS.$('All_TaskHandover'),
    ...
    constructor: function (config) {
        ...
        me.edtComments = Ext.create('Ext.form.field.TextArea', Ext.apply({
            fieldLabel: RS.$('All_HandoverComments'),
            grow: true,
            listeners: {
                change: function () {
                    me.updateStatus();
        ...
        me.btnOK = Ext.create('Ext.button.Button', {
            ...
            cls: 'yz-btn-default',
            handler: function () {
                me.closeDialog(me.edtUsers.getValue()[0], me.edtComments.getValue());
            }
        });
        ...
        me.informPanel = Ext.create('Ext.Component', {
            ...
            data: {
                info: RS.$('All_TaskHandoverCfm_Msg')
            }
        });
