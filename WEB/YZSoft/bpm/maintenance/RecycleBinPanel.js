...
Ext.define('YZSoft.bpm.maintenance.RecycleBinPanel', {
    extend: 'YZSoft.bpm.src.panel.TaskAbstract',
    requires: [
        'YZSoft.bpm.taskoperation.Manager',
        'YZSoft.bpm.src.model.HistoryTask'
    ],
    historyTaskType: 'RecycleBin', //RecycleBin,Deleted,Aborted

    constructor: function (config) {
        var me = this,
            historyTaskType = config.historyTaskType || me.historyTaskType, 
            cfg;
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            ...
            proxy: {
                ...
                extraParams: {
                    ...
                    HistoryTaskType: 'AllAccessableWithDeleted',
                    StatusFilter: historyTaskType,
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: {
                ...
                items: [
                    ...
                    { text: RS.$('All_Status'), dataIndex: 'State', hidden: true, width: 80, align: 'center', tdCls: 'yz-cell-taskstatus', renderer: me.renderTaskStateSimple.bind(me) },
                    {
                        xtype: 'actioncolumn',
        ...
        me.btnContinue = me.createContinueButton(true, {
            text: RS.$('All_BatchRestore')
        });
