...
series
*/
Ext.define('YZSoft.src.designer.container.chart.Pie3DAngleField', {
    ...
    constructor: function (config) {
        ...
        if (angleField && angleField != '__demo__angle1__') {
            items.push({
                xclass: 'YZSoft.src.designer.part.Pie3DAngleField',
                isPart: true,
                cnt: me,
                items: [{
                    xclass: 'YZSoft.src.designer.component.Pie3DAngleField',
    ...
    onDrop: function (source, e, data) {
        ...
        newPart = Ext.create('YZSoft.src.designer.part.Pie3DAngleField', {
            isPart: true,
            dsNode: data.dsNode,
            cnt: me,
            items: [{
    ...
    onDorpPart: function (part) {
        ...
        return Ext.create('YZSoft.src.designer.part.Pie3DAngleField', {
            isPart: true,
            dsNode: part.dsNode,
            cnt: me,
            items: [{
