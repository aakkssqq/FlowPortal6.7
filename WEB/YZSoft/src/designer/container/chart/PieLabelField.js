...
series
*/
Ext.define('YZSoft.src.designer.container.chart.PieLabelField', {
    ...
    constructor: function (config) {
        ...
        if (labelField && labelField != '__demo__label1__') {
            items.push({
                xclass: 'YZSoft.src.designer.part.PieLabelField',
                isPart: true,
                cnt: me,
                items: [{
                    xclass: 'YZSoft.src.designer.component.PieLabelField',
    ...
    onDrop: function (source, e, data) {
        ...
        newPart = Ext.create('YZSoft.src.designer.part.PieLabelField', {
            isPart: true,
            dsNode: data.dsNode,
            cnt: me,
            items: [{
    ...
    onDorpPart: function (part) {
        ...
        return Ext.create('YZSoft.src.designer.part.PieLabelField', {
            isPart: true,
            dsNode: part.dsNode,
            cnt: me,
            items: [{
