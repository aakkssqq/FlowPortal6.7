...
Ext.define('YZSoft.src.designer.container.chart.CombinableYFieldAbstract', {
    extend: 'YZSoft.src.designer.container.chart.YFieldsAbstract',
    opts: {
        tag: 'div',
