...
Ext.define('YZSoft.src.datasource.filter.searchfield.ESB', {
        ...
        me.editorValue = {
            ...
            listeners: {
                beforeedit: function (context) {
                    ...
                    this.setValueType(context.record.data.dataType ? context.record.data.dataType.name:'String'); //数据类型可能为空
                },
    ...
    updateEsbObjectName: function (newValue) {
        var me = this,
            esbObjectName = newValue,
            ds;

        if (Ext.isEmpty(esbObjectName)) {
            me.store.setData([]);
            return;
        }

        ds = Ext.create('YZSoft.src.datasource.ESB', {
