...
*/
Ext.define('YZSoft.src.button.StartArrowPicker', {
    extend: 'Ext.button.Button',
    cls: 'yz-btn-textbox-style',
    iconCls: '',
    width:63,
    text: '<div class="yz-btn-arrow-wrap yz-btn-arrow-start" style=""></div>',

    constructor: function (config) {
        var me = this,
            cfg;

        me.menuPicker = Ext.create('YZSoft.src.menu.StartArrowPicker', {
        });
