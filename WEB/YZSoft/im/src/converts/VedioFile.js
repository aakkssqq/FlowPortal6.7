...
Ext.define('YZSoft.im.src.converts.VedioFile', {
    singleton: true,
    requires: [
    ...
    convert: function (id) {
        ...
        return Ext.String.format('<div class="yz-social-item-video-wrap"><img class="yz-social-item-video" fileid="{0}" src="{1}" style="width:{2}px;height:{3}px"/></div>', id, url, size.width, size.height);
    },
