...
Ext.define('YZSoft.designer.YZSoft.report.chart.PolarChartPie', {
    ...
    initComponent: function () {
        ...
        me.seriesType = Ext.create('Ext.button.Segmented', {
            ...
            items: [{
                value: 'solid',
                icon: YZSoft.$url(me, 'images/PolarChartPie/solid.png')
            }, {
                value: 'donut',
                icon: YZSoft.$url(me, 'images/PolarChartPie/donut.png')
            }],
            value: value,
            listeners: {
                change: function () {
