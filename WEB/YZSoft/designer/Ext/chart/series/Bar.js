...
Ext.define('YZSoft.designer.Ext.chart.series.Bar', {
    ...
    constructor: function (config) {
        ...
        if (!flipXY)
            return Ext.create('YZSoft.designer.Ext.chart.series.Column', config);
    ...
    initComponent: function () {
        ...
        me.seriesType = Ext.create('Ext.button.Segmented', {
            ...
            items: [{
                value: 'group',
                icon: YZSoft.$url(me, 'images/Bar/group.png')
            }, {
                value: 'stacked',
                icon: YZSoft.$url(me, 'images/Bar/stacked.png')
            }, {
                value: 'fullStack',
                icon: YZSoft.$url(me, 'images/Bar/fullStack.png')
            }],
            value: value,
            listeners: {
                change: function () {
