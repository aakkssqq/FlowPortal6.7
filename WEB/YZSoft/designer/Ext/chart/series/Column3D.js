...
Ext.define('YZSoft.designer.Ext.chart.series.Column3D', {
    ...
    initComponent: function () {
        ...
        me.seriesType = Ext.create('Ext.button.Segmented', {
            ...
            items: [{
                value: 'group',
                icon: YZSoft.$url(me, 'images/Column3D/group.png')
            }, {
                value: 'stacked',
                icon: YZSoft.$url(me, 'images/Column3D/stacked.png')
            }, {
                value: 'fullStack',
                icon: YZSoft.$url(me, 'images/Column3D/fullStack.png')
            }],
            value: value,
            listeners: {
                change: function () {
