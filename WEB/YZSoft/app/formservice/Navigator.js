...
root
*/
Ext.define('YZSoft.app.formservice.Navigator', {
    ...
    constructor: function (config) {
        ...
        me.tree = Ext.create('YZSoft.bpm.src.zone.NavigatorTree', {
            storeZoneType: 'FormService',
            securityResType: 'FormApplicationFolder',
            folderPerms: [{
                PermName: 'Read',
                PermType: 'Module',
            ...
            root: {
                text: RS.$('All_FormServiceLib'),
                expanded: false,
                rsid: YZSoft.WellKnownRSID.FormApplicationRoot
            },
            listeners: {
                scope: me,
