            ...
            <tbody>
                <tr>
                    <td height="50" valign="middle" style="BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid" colspan="2">
                        <strong><font size="4">ListBox</font></strong>
                        <br />
                        <font size="1">xclass:YZSoft.Forms.Field.ListBox</font> 
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td height="19" style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid">
                        OU(绑定数据源)</td>
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XListBox id="XListBox1" runat="server" XDataBind="ouid" Width="100%" PromptText="--部门--" XDataSource="TableName:BPMSysOUs" ValueColumn="OUID" DisplayColumn="OUName"></aspxform:XListBox>
                    </td>
                </tr>
                <tr>
                    <td height="19" style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid">
                        User(根据OU过滤)</td>
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XListBox id="XListBox4" runat="server" Width="100%" XDataSource="TableName:v_iDemoOUUsers;Filter:OUID->ouid;BufferType:RuntimeUpdate" ValueColumn="Account" DisplayColumn="DisplayName" DataMap="Description->desc;Birthday->birthday;Mobile->mobile;EMail->email"></aspxform:XListBox>
                    </td>
                </tr>
                <tr>
                    <td height="19" style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid">
                        固定列表</td>
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XListBox id="XListBox2" runat="server" XDataBind="var11" Width="200px" PromptText="--请选择目标城市--" XDataSource Rows="3">
                ...
                <tr>
                    ...
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        ...
                        <aspxform:XListBox id="XListBox3" runat="server" XDataBind="var12" Width="200px" XDataSource Rows="3" Express="var22">
                ...
                <tr>
                    <td width="127" style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid">
                        Description(带出)</td>
                    <td width="423" style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XTextBox id="XTextBox7" runat="server" BorderColor="#DCDCDC" BorderWidth="1" width="100%" XDataBind="desc" Rows="6" TextMode="MultiLine"></aspxform:XTextBox>
                    </td>
                </tr>
                <tr>
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid" colspan="2">
                ...
                <tr>
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid">
                        Disable</td>
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XListBox id="XListBox5" runat="server" Width="200px" PromptText="--请选择目标城市--" XDataSource DisableExpress="Purchase.Amount==1">
                            <asp:ListItem Value="021">上海</asp:ListItem>
                            <asp:ListItem Value="010">北京</asp:ListItem>
                            <asp:ListItem Value="0755">深圳</asp:ListItem>
                        </aspxform:XListBox>
                ...
                <tr>
                    <td height="20" style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid">
                        Hidden</td>
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XListBox id="XListBox6" runat="server" Width="200px" PromptText="--请选择目标城市--" XDataSource HiddenExpress="Purchase.Amount==1">
                            <asp:ListItem Value="021">上海</asp:ListItem>
                            <asp:ListItem Value="010">北京</asp:ListItem>
                            <asp:ListItem Value="0755">深圳</asp:ListItem>
                        </aspxform:XListBox>
                ...
                <tr>
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid">
                        ListBox1</td>
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XListBox id="XListBox7" runat="server" BorderColor="#80FF80" BorderWidth="3px" BorderStyle="Solid" BackColor="#C0FFC0" Width="100%" PromptText="--请选择目标城市--" XDataSource Rows="6" DisableExpress="Purchase.Amount==1">
                            <asp:ListItem Value="021">上海</asp:ListItem>
                            <asp:ListItem Value="010">北京</asp:ListItem>
                            <asp:ListItem Value="0755">深圳</asp:ListItem>
                        </aspxform:XListBox>
                ...
                <tr>
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid">
                        ListBox2</td>
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XListBox id="XListBox8" runat="server" BorderColor="#FF8080" BorderWidth="3px" BorderStyle="Solid" BackColor="#FFE0C0" Width="100%" PromptText="--请选择目标城市--" XDataSource Rows="6" DisableExpress="Purchase.Amount==1">
                            <asp:ListItem Value="021">上海</asp:ListItem>
                            <asp:ListItem Value="010">北京</asp:ListItem>
                            <asp:ListItem Value="0755">深圳</asp:ListItem>
                        </aspxform:XListBox>
