            ...
            <tbody>
                <tr>
                    <td height="53" valign="middle" style="BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid" colspan="2">
                        <strong><font size="4">AddBlockButton</font></strong>&nbsp; 
                        <br />
                        <font size="1">xclass:YZSoft.Forms.Field.AddBlockButton</font> 
                    </td>
                </tr>
                <tr>
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid" colspan="2">
                        <aspxform:XLabel id="XLabel5" runat="server" Font-Size="12px" Font-Bold="True" ForeColor="Black" text="Grid行操作（添加）" TextAlign="Center" Width="100%" BackColor="#C0FFFF" BorderStyle="Solid" BorderColor="Turquoise" BorderWidth="3px" Height="40px"></aspxform:XLabel>
                    </td>
                </tr>
                <tr>
        ...
        <table width="557" style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none" border="0" cellspacing="0" cellpadding="0" dynamicarea="1,1">
            <tbody>
                <tr>
                    ...
                    <td width="99" style="BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none" bgcolor="beige">
                        合计 
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XDropDownList id="XDropDownList1" runat="server" Width="100%" Height="100%" XDataBind="PurchaseDetail.ItemCode" DataMap="Price->PurchaseDetail.Price" DisplayColumn="Name" ValueColumn="ProdCode" XDataSource="TableName:iDemoProduct"></aspxform:XDropDownList>
                    </td>
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                ...
                <tr>
                    <td height="17" style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid" colspan="3">
                        <aspxform:XAddBlockButton id="XAddBlockButton2" runat="server" Height="22px" Text="点击添加行" TableName="PurchaseDetail" DisableExpress="Purchase.Amount==1"></aspxform:XAddBlockButton>
                        <aspxform:XAddBlockButton id="XAddBlockButton3" runat="server" Height="22px" Text="点击添加行" TableName="PurchaseDetail" HiddenExpress="Purchase.Amount==1"></aspxform:XAddBlockButton>
                    </td>
                    <td align="right" style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none" colspan="2">
                        <aspxform:XAddBlockButton id="XAddBlockButton1" runat="server" Height="22px" Text="点击添加行" TableName="PurchaseDetail"></aspxform:XAddBlockButton>
                    </td>
                </tr>
            </tbody>
        </table>
