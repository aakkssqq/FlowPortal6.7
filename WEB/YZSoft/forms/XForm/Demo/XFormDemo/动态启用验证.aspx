...
<body>
    <form id="Form1" runat="server">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none">
                        <aspxform:XRadioButtonList id="XRadioButtonList1" runat="server" XDataBind="请假类型" Width="100%" RepeatDirection="Horizontal">
                    ...
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: medium none" colspan="2">
                        <aspxform:XTextBox id="XTextBox2" runat="server" BorderColor="Gainsboro" width="138px" BorderWidth="1px" Max="0" Min="0" ValueToDisplayText HiddenInput="False" HiddenExpress="请假类型 != '其他'"></aspxform:XTextBox>
                    </td>
                </tr>
                <tr>
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: black 1px solid; BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid">
        ...
        <aspxform:XRequiredFieldValidator id="XRequiredFieldValidator1" runat="server" DisableExpress="请假类型 != '其他'" Display="None" ForeColor="Red" ErrorMessage="请输入说明" ControlToValidate="XTextBox2">请输入说明</aspxform:XRequiredFieldValidator>
        <br />
        <!-- Insert content here -->
    </form>
</body>
