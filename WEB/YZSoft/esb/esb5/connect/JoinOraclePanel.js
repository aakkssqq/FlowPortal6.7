//访问面板
Ext.define('YZSoft.esb.esb5.connect.JoinOraclePanel', {
    ...
    constructor: function (config) {
        ...
        me.joinPanel = Ext.create('Ext.form.Panel', {
            ...
            items: [{
                xtype: 'fieldset',
                title: Ext.String.format(RS.$('ESB_Title_Connection'),'Oracle'),
                defaultType: 'textfield',
                defaults: {
        ...
        Ext.Msg.show({
            ...
            fn:function(btn){
                ...
                form.submit({
                    ...
                    params: { method: 'SaveOracleConnect' ,jointype:me.jointype,connectId:me.connectId},
                    success: function (form, data) {
    ...
    onResetForm:function(form,jointype){
        ...
        form.findField('host').setValue('');
         form.findField('port').setValue('');
