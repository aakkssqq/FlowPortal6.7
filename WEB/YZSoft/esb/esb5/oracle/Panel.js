//SQL源操作面板
Ext.define('YZSoft.esb.esb5.oracle.Panel', {
    ...
    onAnalysisSql:function(){
        ...
        if (!queryStr)
            return;
        YZSoft.Ajax.request({
            url: 'YZSoft.Services.REST/ESB5/Oracle.ashx',
        ...
        YZSoft.Ajax.request({
            ...
            success: function (data) {
                 me.resultGrid  = Ext.create('YZSoft.esb.esb5.src.grid.ResultPanel',{
                    ...
                    caption:me.caption,
                    connectId:me.connectId,
                    savePath:'YZSoft.Services.REST/ESB5/Oracle.ashx',
                    scrollable: true,
                    multiSelect: true,
