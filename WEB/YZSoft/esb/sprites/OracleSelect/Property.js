...
sprite
*/
Ext.define('YZSoft.esb.sprites.OracleSelect.Property', {
    ...
    constructor: function (config) {
        ...
        me.pnlGeneral = Ext.create('YZSoft.esb.sprites.OracleSelect.propertypages.General', Ext.apply({
        ...
        me.pnlInputMap = Ext.create('YZSoft.esb.sprites.OracleSelect.propertypages.InputMap', Ext.apply({
            title: RS.$('ESB_PropertyPage_Title_Call'),
            padding: '0 0 0 0',
        }, itemCfg));

        me.pnlOutputMap = Ext.create('YZSoft.esb.sprites.OracleSelect.propertypages.OutputMap', Ext.apply({
