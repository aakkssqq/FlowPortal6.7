...
Ext.define('YZSoft.esb.sprites.OracleInsert.propertypages.InputMap', {
    extend: 'YZSoft.src.jmap.ESBActivityInputMap',
    tagTreeXClass: 'YZSoft.esb.sprites.OracleInsert.tree.InputTree',
    config: {
        connectionName: null,
        query: null
    },
    ...
    $refresh: function (cfg) {
        ...
        YZSoft.Ajax.request(Ext.apply({
            ...
            success: function (action) {
                delete action.result.QueryParams.properties.id;
