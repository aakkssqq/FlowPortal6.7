...
sprite
*/
Ext.define('YZSoft.esb.sprites.OracleInsert.Property', {
    ...
    constructor: function (config) {
        ...
        me.pnlGeneral = Ext.create('YZSoft.esb.sprites.OracleInsert.propertypages.General', Ext.apply({
        ...
        me.pnlInputMap = Ext.create('YZSoft.esb.sprites.OracleInsert.propertypages.InputMap', Ext.apply({
            title: RS.$('ESB_PropertyPage_Title_Call'),
            padding: '0 0 0 0',
        }, itemCfg));

        me.pnlOutputMap = Ext.create('YZSoft.esb.sprites.OracleInsert.propertypages.OutputMap', Ext.apply({
