...
Ext.define('YZSoft.esb.sprites.PdfGenerator.propertypages.InputMap', {
    extend: 'YZSoft.src.jmap.ESBActivityInputMap',
    tagTreeXClass:'YZSoft.esb.sprites.PdfGenerator.tree.InputTree',
    config: {
        templateName: null
    },
    ...
    constructor: function (config) {
        ...
        me.tagTreeConfig = {
            title: RS.$('ESB_PdfGenerator_InputTree_Title'),
            tools: [{
                type: 'refresh',
                handler: function () {
                    me.$refresh({
