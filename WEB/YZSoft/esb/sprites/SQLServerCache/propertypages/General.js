...
relatedFile
*/
Ext.define('YZSoft.esb.sprites.SQLServerCache.propertypages.General', {
    extend: 'Ext.form.Panel',
    requires: [
        'YZSoft.src.form.field.ConnectionField',
        'YZSoft.src.form.field.SQLServerTableCombo'
    ],
    layout: {
        type: 'vbox',
        align:'stretch'
    ...
    initComponent: function () {
        ...
        me.cmbTables = Ext.create('YZSoft.src.form.field.SQLServerTableCombo', {
