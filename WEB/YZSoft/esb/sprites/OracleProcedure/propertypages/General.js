...
relatedFile
*/
Ext.define('YZSoft.esb.sprites.OracleProcedure.propertypages.General', {
    extend: 'Ext.form.Panel',
    requires: [
        'YZSoft.src.form.field.ConnectionField',
        'YZSoft.src.form.field.OracleProcedureCombo'
    ],
    layout: {
        type: 'vbox',
        align:'stretch'
    ...
    initComponent: function () {
        ...
        me.cmbProcedures = Ext.create('YZSoft.src.form.field.OracleProcedureCombo', {
