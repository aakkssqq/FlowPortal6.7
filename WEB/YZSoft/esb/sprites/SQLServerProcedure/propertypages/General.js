...
relatedFile
*/
Ext.define('YZSoft.esb.sprites.SQLServerProcedure.propertypages.General', {
    extend: 'Ext.form.Panel',
    requires: [
        'YZSoft.src.form.field.ConnectionField',
        'YZSoft.src.form.field.SQLServerProcedureCombo'
    ],
    layout: {
        type: 'vbox',
        align:'stretch'
    ...
    initComponent: function () {
        ...
        me.cmbProcedures = Ext.create('YZSoft.src.form.field.SQLServerProcedureCombo', {
