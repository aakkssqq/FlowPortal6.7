...
sprite
*/
Ext.define('YZSoft.esb.sprites.MySQLProcedure.Property', {
    ...
    constructor: function (config) {
        ...
        me.pnlGeneral = Ext.create('YZSoft.esb.sprites.MySQLProcedure.propertypages.General', Ext.apply({
        ...
        me.pnlInputMap = Ext.create('YZSoft.esb.sprites.MySQLProcedure.propertypages.InputMap', Ext.apply({
            title: RS.$('ESB_PropertyPage_Title_Call'),
            padding: '0 0 0 0',
        }, itemCfg));

        me.pnlOutputMap = Ext.create('YZSoft.esb.sprites.MySQLProcedure.propertypages.OutputMap', Ext.apply({
