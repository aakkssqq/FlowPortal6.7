...
config
*/
Ext.define('YZSoft.esb.admin.FlowPanel', {
    extend: 'YZSoft.src.library.zone.Panel',
    requires: [
        'YZSoft.esb.model.Flow'
    ],
    serviceUrl: YZSoft.$url('YZSoft.Services.REST/ESB/Flow/Admin.ashx'),
    folderSecurityResType: 'ESBFlowFolder',
    rootRSID: YZSoft.WellKnownRSID.ESBFlowRoot,
    storeZoneType: 'ESBFlow',
    viewType: 'icon',
    addNewObjectText: RS.$('ESB_Flow_AddNew'),
    folderPerms: [{
        PermName: 'Read',
        PermType: 'Module',
    ...
    constructor: function (config) {
        ...
        me.viewStore = me.createViewStore({
            model: 'YZSoft.esb.model.Flow'
        });

        me.treeStore = me.createTreeStore({
            root: {
                text: RS.$('ESB_FlowRoot'),
                expanded: false,
                rsid: me.rootRSID
            }
        });
    ...
    addNew: function () {
        ...
        panel = Ext.create('YZSoft.esb.designer.FlowDesigner', {
            designMode: 'new',
