...
objectName
*/
Ext.define('YZSoft.connection.connections.Oracle.Dlg', {
    extend: 'YZSoft.connection.connections.DlgAbstract',
    title: RS.$('Connection_OracleDlg_Title'),
    bodyPadding: 0,
    minHeight: 478,
    default: {
        r: {
    ...
    viewModel: {
        formulas: {
            testdisabled: function (get) {
                return !get('r.Cn.Host') || !get('r.Cn.Port') || !get('r.Cn.UserID') || !get('r.Cn.SID');
            },
    ...
    createPageGeneral: function (config) {
        return Ext.create('Ext.panel.Panel', Ext.apply({
            ...
            items: [{
                ...
                xtype: 'textfield',
                fieldLabel: RS.$('Connection_Oracle_Host'),
                bind: '{r.Cn.Host}'
            }, {
                xtype: 'textfield',
