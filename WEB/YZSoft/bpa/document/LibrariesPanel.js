...
Ext.define('YZSoft.bpa.document.LibrariesPanel', {
    ...
    constructor: function (config) {
        ...
        me.titlebar = Ext.create('YZSoft.bpa.document.toolbar.LibrariesTitleBar', {
            region: 'north',
            height: 64,
            newBtnConfig: {
        ...
        me.view = Ext.create('YZSoft.bpa.document.view.LibrariesView', {
            region: 'center',
            padding: '30 0 0 36'
        });
    ...
    onItemClick: function (view, record) {
        ...
        cnt.showModule({
            xclass: 'YZSoft.bpa.document.LibraryPanel',
            config: {
