...
//左右箭头
Ext.define('YZSoft.bpa.sprite.General.DoubleHorizontalArrow', {
    ...
    updatePath: function (path, attr) {
        ...
        path.lineTo(x + Math.min(h * 0.5, w * 0.45),y);
        path.lineTo(x + Math.min(h * 0.5, w * 0.45), y + h * 0.33);
        ...
        path.lineTo(x + Math.min(h * 0.5, w * 0.45), y + h * 0.67);
        path.lineTo(x + Math.min(h * 0.5, w * 0.45), y + h);
        path.closePath();
    }
});
