...
//备注
Ext.define('YZSoft.bpa.sprite.General.RightBrace', {
    ...
    updatePath: function (path, attr) {
        ...
        path.moveTo(x, y + h);
        path.quadraticCurveTo(x + Math.min(w * 0.1, 9), y + h, x + Math.min(w * 0.1, 9), y + h - Math.min(h * 0.1, 9));
        path.lineTo(x + Math.min(w * 0.1, 9), y + h * 0.5 + Math.min(h * 0.1, 9));
        path.quadraticCurveTo(x + Math.min(w * 0.1, 9), y + h * 0.5, Math.min(w * 0.2, 22), y + h * 0.5);
        path.quadraticCurveTo(x + Math.min(w * 0.1, 9), y + h * 0.5, x + Math.min(w * 0.1, 9), y + h * 0.5 - Math.min(h * 0.1, 9));
        path.lineTo(x + Math.min(w * 0.1, 9), y + Math.min(h * 0.1, 9));
        path.quadraticCurveTo(x + Math.min(w * 0.1, 9), y, x, y);
    }
});
