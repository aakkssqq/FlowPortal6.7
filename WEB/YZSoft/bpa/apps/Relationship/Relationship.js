...
Ext.define('YZSoft.bpa.apps.Relationship.Relationship', {
    ...
    constructor: function (config) {
        ...
        me.edtDir = Ext.create('Ext.button.Segmented', {
            items: [{
                text: RS.$('BPA_Relationship_Relatited'),
                pressed: true,
                value: 'RelationshipAppGetRelatited'
            }, {
                text: RS.$('BPA_Relationship_UsedBy'),
                value: 'RelationshipAppGetUsedBy'
            }]
        });
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: {
                ...
                items: [
                    ...
                    { text: RS.$('BPA__Module'), dataIndex: 'FileName', flex: 1, formatter: 'text' },
                    { text: RS.$('BPA__SpriteName'), dataIndex: 'SpriteName', flex: 1, formatter: 'text' },
                    { text: RS.$('BPA__RelatiedFileName'), dataIndex: 'RelatiedFileName', flex: 1, formatter: 'text' },
                    { text: RS.$('All_BPM_BPAActivityLink_PlaceHolder'), dataIndex: 'RelatiedSpriteName', flex: 1, formatter: 'text' }
                ]
            }
        });
        ...
        me.btnExport = Ext.create('YZSoft.src.button.ExcelExportButton', {
            grid: me.grid,
            templateExcel: YZSoft.$url(me, 'Relationship.xls'),
            params: {},
            fileName: RS.$('BPA_SearchRelationship'),
            defaultRadio: 'all',
            radioDisabled: true,
            btnConfig: {
                margin: '0 0 0 5'
