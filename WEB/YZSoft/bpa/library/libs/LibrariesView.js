...
Ext.define('YZSoft.bpa.library.libs.LibrariesView', {
    extend: 'YZSoft.src.lib.View',
    requires: [
        'YZSoft.src.model.Library'
    ],
    cls: 'bpa-dataview-lib',
    tpl: [
        '<tpl for=".">',
            '<div class="yz-dataview-item yz-dataview-item-block bpa-dataview-item-lib bpa-dataview-item-lib-lib">',
                '<div class="inner">',
    ...
    constructor: function (config) {
        ...
        me.store = Ext.create('Ext.data.JsonStore', {
            model: 'YZSoft.src.model.Library',
            proxy: {
                type: 'ajax',
    ...
    edit: function (record, config) {
        ...
        Ext.create('YZSoft.app.library.LibDlg', {
            ...
            perm: config.perm,
            logoConfig: {
                cls: 'yz-form-field-bpaprocesslib-logo'
            },
            fn: function (data) {
                var dlg = this;
