...
Ext.define('Demo.SJ.CustomerPanel', {
        ...
        me.grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: {
                ...
                items: [
                    ...
                    { header: '客户名称', dataIndex: 'CompanyName', width: 100, align: 'left', sortable: true },
                    { header: '地址', dataIndex: 'Addr', flex: 1, align: 'left', sortable: true },
                    { header: '联系人', dataIndex: 'Contact', width: 160, align: 'left', sortable: true },
                    { header: '电话', dataIndex: 'Phone', width: 160, align: 'left' }
                ]
            },
    ...
    edit: function (rec) {
        ...
        YZSoft.bpm.src.ux.FormManager.openFormApplication('Demo/SJ/客户登记', rec.data.id, 'Edit', Ext.apply({
            sender: me,
            title: Ext.String.format('客户名称 - {0}', rec.data.CompanyName),
            listeners: {
                submit: function (action, data) {
                    me.store.reload({
                        loadMask: {
